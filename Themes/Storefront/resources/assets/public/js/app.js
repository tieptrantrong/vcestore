...
import FeaturedCategoriesTable from './components/home/FeaturedCategoriesTable.vue';
...
import HomeTopCertifications from './components/home/HomeTopCertifications.vue';
...
import CertificationCategory from './components/home/Category';
import ProductCardGridView from './components/products/index/ProductCardGridView.vue';
import HomeProductCardGridView from './components/home/HomeProductCardGridView.vue';
import HomeProductTableView from './components/home/HomeProductTableView.vue';
import ProductCardListView from './components/products/index/ProductCardListView.vue';
import ProductGridView from './components/products/index/ProductGridView.vue';
import ProductTableView from './components/products/index/ProductTableView.vue';
import ProductListView from './components/products/index/ProductListView.vue';
...
Vue.component('featured-categories-table', FeaturedCategoriesTable);
Vue.component('banner-three-column-full-width', BannerThreeColumnFullWidth);
Vue.component('product-tabs-one', ProductTabsOne);
Vue.component('home-top-certifications', HomeTopCertifications);
...
Vue.component('certification-category', CertificationCategory);
Vue.component('product-card-grid-view', ProductCardGridView);
Vue.component('home-product-card-grid-view', HomeProductCardGridView);
Vue.component('home-product-table-view', HomeProductTableView);
Vue.component('product-grid-view', ProductGridView);
Vue.component('product-card-list-view', ProductCardListView);
Vue.component('product-table-view', ProductTableView);
Vue.component('product-list-view', ProductListView);
