...
Route::get('storefront/featured-categories/{categoryNumber}/allProducts', 'FeaturedCategoryProductController@all')->name('storefront.featured_category_products.all');
