            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#option-<%- optionId %>" href="#custom-collapse-<%- optionId %>">
                        <span id="product-url" class="pull-left"><?php echo e(trans('product::products.private_product.new_product')); ?></span>
                    </a>
                </h4>
            </div>
                    ...
                    <div class="new-option clearfix">
                        ...
                        <div class="col-lg-11 col-md-11 p-l-0">
                            <div class="form-group">
                                <label for="option-<%- optionId %>-name"><?php echo e(trans('product::products.private_product.url')); ?></label>
                        ...
                        <div class="col-lg-1 col-md-1 p-l-0">
                            <button type="button" class="btn btn-default delete-option pull-right" data-toggle="tooltip" title="<?php echo e(trans('product::products.private_product.delete_product')); ?>">
...
<?php /**PATH /var/www/vcestore/Modules/Product/Resources/views/admin/products/partials/private_product.blade.php ENDPATH**/ ?>