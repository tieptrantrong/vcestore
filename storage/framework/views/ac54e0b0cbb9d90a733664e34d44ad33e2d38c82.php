                ...
                <div class="row">
                    <div class="col products-left">
                        <div class="product-details-top">
                                    ...
                                    <div class="col">
                                        <div class="product-details-info">
                                            <div class="details-info-top">
                                                ...
                                                <?php if($product->questions > 0): ?>
                                                <p class="product-subtitle">Includes <?php echo e($product->questions); ?> Questions & Answers</p>
                                                <?php endif; ?>
                            ...
                            <?php echo $__env->make('public.products.show.right_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                            ...
                            <div class="product-details-bottom-inner">
                                <div class="product-details-tab clearfix">
                                    <ul class="nav nav-tabs tabs">
                                        <li class="nav-item">
                                            <a href="#public-resources" data-toggle="tab" class="nav-link" :class="{ active: activeTab === 'public-resources' }">
                                                <?php echo e(trans('storefront::product.public_resources')); ?>
                                    ...
                                    <div class="tab-content">
                                        <?php echo $__env->make('public.products.show.tab_public_resources', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('public.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vcestore/Themes/Storefront/views/public/products/show.blade.php ENDPATH**/ ?>