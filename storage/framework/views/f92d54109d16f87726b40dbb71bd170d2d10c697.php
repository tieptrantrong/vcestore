                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="id-field" class="hide">
                                            <?php echo e(Form::text('id', trans('category::attributes.id'), $errors, null, ['labelCol' => 2, 'disabled' => true])); ?>

                                        </div>

                                        <?php echo e(Form::text('name', trans('category::attributes.name'), $errors, null, ['labelCol' => 2, 'required' => true])); ?>

                                        <?php echo e(Form::wysiwyg('description', trans('category::attributes.description'), $errors, null, ['labelCol' => 2, 'required' => false])); ?>

                                        <?php echo e(Form::checkbox('is_searchable', trans('category::attributes.is_searchable'), trans('category::categories.form.show_this_category_in_search_box'), $errors, null, ['labelCol' => 2, 'required' => false])); ?>

                                        <?php echo e(Form::checkbox('is_active', trans('category::attributes.is_active'), trans('category::categories.form.enable_the_category'), $errors, null, ['labelCol' => 2, 'required' => false])); ?>

                                        <?php echo e(Form::checkbox('is_hot', trans('category::attributes.is_hot'), trans('category::categories.form.enable_the_category'), $errors, null, ['labelCol' => 2, 'required' => false])); ?>
...
<?php echo $__env->make('admin::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vcestore/Modules/Category/Resources/views/admin/categories/index.blade.php ENDPATH**/ ?>