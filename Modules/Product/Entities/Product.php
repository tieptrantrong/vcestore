...
use Modules\Product\Entities\PrivateUrlProduct;
...
class Product extends Model
{
    ...
    {
        return $this->hasMany(PrivateUrlProduct::class, 'product_id');
    }

    public function privateProducts()
    {
        return $this->belongsToMany(PrivateUrlProduct::class, 'private_url_products', '', 'product_id');
    }
     ...
     * @return \Illuminate\Database\Eloquent\Collection
     */
    public function getPublicResourcesAttribute()
    {
        return $this->files
